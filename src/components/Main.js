    ...
    return (
        <div>
           	<div style={{"margin":"0 40px"}}>
		        ...
		        <table id="table" data-toggle="table" data-search="true" data-search-align="right" data-url="https://blswlgmowg.execute-api.us-east-1.amazonaws.com/Production/emission"  data-pagination="true" data-sort-name="Unique_ID"
  data-sort-order="asc" data-search-highlight="true" data-filter-control="true" data-detail-formatter="detailFormatter"  data-detail-view="true">
			        <thead>
			        	<tr style={{"backgroundColor":"#fbfbfb"}}>
                            ...
                            <th data-field="VALUE" data-sortable="true"  data-formatter="nameFormatterValue">VALUE</th>
                            <th data-field="FACTOR" data-sortable="true" data-formatter="nameFormatterFactor">FACTOR</th>
